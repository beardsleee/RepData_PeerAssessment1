...
legend("topright",pch=c(15,NA_integer_,15,NA_integer_),col=c("red","red","blue","blue"),legend=c("Median:",median(stepsperday,na.rm=TRUE),"Mean:",mean(stepsperday,na.rm=TRUE)))
```
